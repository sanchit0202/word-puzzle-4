...
function getPositions(){
    sPos = Math.round(s.getXPosition());
    aPos = Math.round(a.getXPosition());
    nPos = Math.round(n.getXPosition());
    cPos = Math.round(c.getXPosition());
    hPos = Math.round(h.getXPosition());
    iPos = Math.round(i.getXPosition());
    tPos = Math.round(t.getXPosition());
    
    if(sPos < aPos && aPos < nPos && nPos < cPos && cPos < hPos && hPos < iPos && iPos < tPos){
